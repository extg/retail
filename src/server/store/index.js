    ...
    products: [
      {
        ...
        ratio: 5,
        nalichie: 'В наличии',
        info: 'Смартфон Microsoft Lumia 640 Dual SIM (RM-1077) С ним вы открываете мир ярких цифровых возможностей. ' +
        'Этот многофункциональный смартфон уже содержит набор бесплатных сервисов Microsoft...',
        price: 9823
      }, {
        ...
        ratio: 2,
        nalichie: 'В наличии',
        info: 'Смартфон Philips S398 Black. Черный корпус и разнообразие цветных панелей для Philips S398 как ' +
        'нельзя лучше подчеркнут ваш статус и уверенность в себе. Преимущества этой модели...',
        price: 12932
      }, {
        ...
        ratio: 4,
        nalichie: 'В наличии',
        info: 'Смартфон Microsoft Lumia 430 RM-1099 black Куда бы вы ни направлялись, ' +
        'смартфон должен быть надежным спутником. Поэтому у Microsoft Lumia 430 Dual SIM (RM-1099) удобный',
        price: 5632
      }, {
    ...
    products: [
      {
        ...
        nalichie: 'В наличии',
        info: 'Смартфон Microsoft Lumia 430 RM-1099 black Куда бы вы ни направлялись, ' +
        'смартфон должен быть надежным спутником. Поэтому у Microsoft Lumia 430 Dual SIM (RM-1099) удобныйкорпус..',
        price: 5392
      }, {
        ...
        ratio: 5,
        nalichie: 'В наличии',
        info: 'Смартфон HIGHSCREEN WinWin Black оснащен 4 дисплеем и двумя слотами для SIM-карт.  Windows Phone , ' +
        '3G, Bluetooth, USB-подключение к ПК...',
        price: 13992
      }, {
        ...
        ratio: 4,
        nalichie: 'В наличии',
        info: 'Смартфон Alcatel OT4013D PIXI 3 (2 SIM). Смартфон Alcatel One Touch 4013D оснащен четырехдюймовым ' +
        'дисплеем и двумя слотами для SIM-карт...',
        price: 3892
      }, {
        ...
        ratio: 3,
        nalichie: 'В наличии',
        info: 'Смартфон Fly IQ434 Era Nano 5 оснащен 3.5 дисплеем и двумя слотами для SIM-карт. Android 2.3,' +
        ' Micro SD, Wi-Fi.... ',
        price: 1790
      }, {
    ...
    filters: [
      {
        ...
        id: 'color',
        type: 'color',
        values: ['white', 'gray', 'black', 'blue', 'red', 'yellow', 'orange', 'green', 'skyblue', 'violet', 'pink'],
        reset: true
      }, {
        name: 'Операционная система',
        open: 'yes',
    ...
    products: [
      {
        ...
        ratio: 5,
        nalichie: 'В наличии',
        info: 'Смартфон HIGHSCREEN WinWin Black оснащен 4 дисплеем и двумя слотами для SIM-карт.  Windows Phone , 3G,' +
        'Bluetooth, USB-подключение к ПК...',
        price: 6273
      }
    ],
    filters: [
